...
for seed in 3 7 33; do
    ...
    for k in 3 7; do
        ...
        echo ">>> Running E1 ($k-Fold): Train on Synthetic → Test on FPB + C2050"
        ...
        echo ">>> Running E2 ($k-Fold): Train on FPB → Test on Synthetic + C2050"
        ...
        echo ">>> Running E3 ($k-Fold): Train on Chronicle2050 → Test on Synthetic + FPB"
        ...
        echo ">>> Running E4 ($k-Fold): Train on Synthetic+FPB → Test on C2050"
        ...
        echo ">>> Running E5 ($k-Fold): Train on Synthetic+C2050 → Test on FPB"
        ...
        echo ">>> Running E6 ($k-Fold): Train on FPB+C2050 → Test on Synthetic"
