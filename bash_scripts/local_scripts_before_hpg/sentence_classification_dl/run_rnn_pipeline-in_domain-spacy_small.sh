#!/bin/bash
# run_rnn_pipeline-in_domain-spacy_small.sh - RNN smoke test with 50 samples and 3 epochs across three seeds
#
# Usage:
#   chmod +x run_rnn_pipeline-in_domain-spacy_small.sh
#   bash run_rnn_pipeline-in_domain-spacy_small.sh
