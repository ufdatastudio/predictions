#!/bin/bash
# run_llm_gemma_3_27b-pipeline-evaluation-spacy_small.sh
#
# Usage:
#   chmod +x run_llm_gemma_3_27b-pipeline-evaluation-spacy_small.sh
#   bash run_llm_gemma_3_27b-pipeline-evaluation-spacy_small.sh
