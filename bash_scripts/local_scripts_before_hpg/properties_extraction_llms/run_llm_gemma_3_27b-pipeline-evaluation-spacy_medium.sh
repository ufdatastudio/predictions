#!/bin/bash
# run_llm_gemma_3_27b-pipeline-evaluation-spacy_medium.sh
#
# Usage:
#   chmod +x run_llm_gemma_3_27b-pipeline-evaluation-spacy_medium.sh
#   bash run_llm_gemma_3_27b-pipeline-evaluation-spacy_medium.sh
