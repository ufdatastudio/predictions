...
DEFAULT_DATASET = "TimeBank_LLM_Test.csv"
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Path relative to TimeBank_LLM_Test.csv)",
    )
    parser.add_argument(
        "--panel-models",
        nargs=3,
...
def main() -> None:
    ...
    data_path = os.path.join(script_dir, args.dataset)
    ...
    #Note: panel_models is a dictionary
    #So, change panel_models to a list
    ...
    print("\nPanel models:")
    for model in panel_models: 
        #Looping through the dictionary gives you the key, which will be a string based on the code
        print(f"  - {model.__name__()}")
        #You cannot use the __name__ operator here
